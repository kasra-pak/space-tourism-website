...
import { Hero, Container, Title, TabImg, Slider, Info, Circle, Term, TechName, Text, TabImgPortrait } from "./Technology.styled";
  ...
  return (
    ...
    <Container>
      <section>
        ...
        <TabImgPortrait src={currTechData.images.portrait} alt={currTechData.name} />
      </section>
    </Container>
  </Hero>
  )
